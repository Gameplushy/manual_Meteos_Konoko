...
Locations are checked by winning a random match as a planet.
...
You'll start the game playing with 5-star AI Level and 5-star difficulty. There are 4 "Progressive AI Lobotomy" and 4 "Progressive Difficulty Lobotomy" to lower the difficulty of each difficulty setting, one of each should be obtained early on.
